...
- Pick the agent by calling list_agents (it returns the real agents and their ids). If the user named an agent (e.g. "Valod"), find the matching one and use its agent_id; if none matches or none was named, show the list and ask the user to choose. Only ever use an agent name, id, and voice that list_agents returned — never invent one.
